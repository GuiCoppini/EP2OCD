public class Operation {
    /*
     * TODO ARRUMAR AS SETAGENS DAS FLAGS NAS OPERACOES NECESSARIAS MOV CMP
     * JUMPS MAPEAR O MICROCODIGO DE CADA OPERACAO
     */
    ...
    public static void executa(int pc) {
        ...
        String arg2 = null;
        try {
            arg2 = parts[1].replaceAll("\\s+", "");
        } // nem sempre temos dois argumentos
        catch (Exception e) {
        }
        ...
        switch (posicao) {
            case 0: // mov(vale lembrar q temos 3 casos dentro do mov)
                ...
                break;
            case 1: // add
                // System.out.println("ADD"); // so serao usados registradores e
                // constantes segundo o enunciado
    ...
    private static int find(int a) { // encontra dentro do array de operacoes,
        // qual estamos executando e retorna a
        // posicao
        String comando = Principal.memoria[a].substring(0, 3);
        for (int h = 0; h < line.length; h++) {
            if (comando.equals(line[h]))
                return h;
            // nao deve retornar a posicao apenas, e sim o op code para podermos
            // trabalhar com ele.
        }
        System.out.println("äaaaaaaaaeeeeeeeeeeeeeeeeeehooooooooooooooooooooooooooooo nao achou a string"); // obviamente
        // nao
        // queremos
        // chegar
        // aqui
