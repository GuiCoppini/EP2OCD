	...
	public static void executa(int pc){
		...
		switch (posicao) {
			case 0: //mov(vale lembrar q temos 3 casos dentro do mov)
				...
				break;
			case 1: //add
				try{Principal.registrador(arg1) += Principal.registrador(arg2);}
				catch (Exception e){
				    try{Principal.registrador(arg1) += Integer.parseShort(arg2);}
				    catch(Exception e1){
				        Principal.registrador(arg2) += Integer.parseShort(arg1);
				    }
				}
				break;
			case 2: //sub
